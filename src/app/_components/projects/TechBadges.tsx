...
function getIcon(name: string) {
  ...
  if (key === "react" || key === "react.js") return <SiReact />;
  ...
  if (key === "xml" || key === "sped parsing") return <FileJson size={14} />;
  ...
  if (key === "business automation") return <Zap size={14} />;
  if (key === "dashboards") return <BarChart2 size={14} />;
  if (key === "openvpn") return <Shield size={14} />;
